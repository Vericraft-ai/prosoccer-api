...
export interface ProsoccerPlayersInterface extends utils.Interface {
  functions: {
...
export interface ProsoccerPlayers extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProsoccerPlayersInterface;
